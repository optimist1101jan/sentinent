...
The `<memory_bank>` section is **ONLY** included when user input indicates memory-related intent. This saves tokens and keeps responses focused.
...
- **Shared Utilities:** `pipeline/renderer_base.py`
